...
to setup
  ...
  set sheep-speed 1
  ;set minimum-separation 2
  set maximum-separation 6
...
to move
  ...
  [;if i'm a wolf
    ...
    ifelse is-wolf-found? and is-sheep-found?
    [
;      ifelse distance closest-wolf <= 1.5
;      [
;        face closest-wolf
;        bk wolf-speed * 0.5
;        face closest-sheep
...
;      ]
    ...
    [
      ifelse is-wolf-found? ; else if there is a wolf - run
      [
        face closest-wolf
        rt 180
        fd wolf-speed
      ...
      [
        ifelse is-sheep-found? ; if there is a sheep follow her
        [
          face closest-sheep
          fd wolf-speed
        ]
        [ wander ] ; if there nobody just wander
      ]
    ]
  ]
  ...
  [;if i'm a sheep
    ...
    ifelse is-wolf-found? ; if there is a wolf - run
    [
      face closest-wolf
      rt 180
      fd sheep-speed
    ...
    [
      ifelse is-sheep-found? ; if there is a sheep
      [
        ifelse maximum-separation < distance closest-sheep ; and distance closest-sheep > minimum-separation
        [ ; and you're far enough from your buddies go to them
          ;show (word "Dist to closest sheep: " distance closest-sheep )
          face closest-sheep
          fd sheep-speed
...
to eat-sheep  ; wolf procedure
  let prey one-of sheep in-radius 1.125                   ; grab a random sheep
...
to death  ; turtle procedure (i.e. both wolf and sheep procedure)
  ...
  [
    ...
    [
      if random-float 100 < 25 [ ask one-of wolves-here [ die ] ]
    ]
  ]
